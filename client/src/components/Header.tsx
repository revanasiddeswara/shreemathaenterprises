      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-4">
                ...
                {services.map((service) => (
                  <DropdownMenuItem key={service.href} asChild>
                    <Link
                      ...
                      data-testid={`dropdown-${service.name
                        .toLowerCase()
                        .replace(/\s+/g, "-")}`}
                    >
          ...
          <div className="flex items-center gap-2">
            <a href="tel:+918951682834" className="hidden sm:block">
              <Button
                variant="outline"
                size="sm"
                  ...
                  {navLinks.map((link) => (
                    ...
                    >
                      <Button
                        ...
                        data-testid={`mobile-nav-${link.name
                          .toLowerCase()
                          .replace(/\s+/g, "-")}`}
                      >
                        {link.name}
                  ...
                  {services.map((service) => (
                    ...
                    >
                      <Button
                        ...
                        data-testid={`mobile-service-${service.name
                          .toLowerCase()
                          .replace(/\s+/g, "-")}`}
                      >
